...
SUDO_USERS = [6414266397]

AUTH_CHANNEL = -1002446676469
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="")]])
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text5.strip() == "/d":
        ...
        app = raw_text5.strip() or "Support"
        ...
        'X-CDN-Tag': 'empty'
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"**⚡Dᴏᴡɴʟᴏᴀᴅɪɴɢ Sᴛᴀʀᴛᴇᴅ...⏳**\n" \
                           f"🔗𝐋𝐢𝐧𝐤 » {url}\n" \
                           f"✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [Support❤️](https://t.me/+MdZ2996M2G43MWFl)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.download_video(url, cmd, name)
                    filename = res_file
                    await prog.delete(True)
